...
$rad_dashboard_options_all = array(
	...
	'form_setup' => array(
		...
		'button_redirect' => array(
			...
			'class'           => 'rad_dashboard_redirect_checkbox',
			'default'         => false,
			'conditional'	  => 'email_text#redirect_url#name_fields',
			'validation_type' => 'boolean',
			'display_if'      => implode( '#', $show_name_fields ).'#redirect',
		),
		'redirect_url' => array(
			'type'            => 'input_field',
			'subtype'         => 'text',
		...
		'name_fields' => array(
			...
			'validation_type' => 'simple_text',
			'display_if'      => implode( '#', $show_name_fields ).'#button_redireect#false',
		),
		'name_text' => array(
			'type'            => 'input_field',
			'subtype'         => 'text',
	...
	'success_message' => array(
		...
		'option' => array(
			...
			'class'           => 'rad_dashboard_success_text rad_dashboard_for_rapidbar',
