...
$rad_dashboard_options_all = array(
	...
	'form_integration' => array(
		...
		'enable_redirect_form' => array(
			...
			'conditional'	  =>  'redirect_list_id#email_text#redirect_url#submit_remove,#enable_success_redirect#enable_consent#redirect_new_tab_bar#redirect_new_window_bar#redirect_current_window_bar',
		),
	...
	'form_setup' => array(
		...
		'redirect_current_window_bar' => array(
		  'type'            => 'checkbox',
		  'title'           => __( 'Replace current window', 'rapidology' ),
		  'name'            => 'redirect_current_window_bar',
		  'default'         => false,
		  'class' 		  => 'rad_rapidology_redirect_current_window_bar',
		  'validation_type' => 'boolean',
		  'display_if'		=> 'enable_redirect_form#true',
		),
		'redirect_new_tab_bar' => array(
		  'type'            => 'checkbox',
		  'title'           => __( 'Open redirect in new tab', 'rapidology' ),
		  'name'            => 'redirect_new_tab_bar',
		  'default'         => false,
		  'class' 		  	=> 'rad_rapidology_redirect_new_tab_bar',
		  'validation_type' => 'boolean',
		  'display_if'		=> 'enable_redirect_form#true',
		),
		'redirect_new_window_bar' => array(
		  'type'            => 'checkbox',
		  'title'           => __( 'Open redirect in new window', 'rapidology' ),
		  'name'            => 'redirect_new_window_bar',
		  'default'         => false,
		  'class' 		  => 'rad_rapidology_redirect_new_window_bar',
		  'validation_type' => 'boolean',
		  'display_if'		=> 'enable_redirect_form#true',
		),
	...
	'success_redirect' => array(
		...
		'redirect_current_window' => array(
		  'type'           		  => 'checkbox',
		  'title'           	  => __( 'Replace current window', 'rapidology' ),
		  'name'                  => 'redirect_current_window',
		  'default'               => false,
		  'class' 		          => 'rad_rapidology_redirect_current_window',
		  'validation_type'       => 'boolean',
		),
		'redirect_new_tab' => array(
		  'type'            => 'checkbox',
		  'title'           => __( 'Open redirect in new tab', 'rapidology' ),
	...
	'optin_design_options' => array(
		...
		$rad_dashboard_options_all[ 'form_setup' ][ 'section_start' ],
			...
			$rad_dashboard_options_all[ 'form_setup' ][ 'redirect_url' ],
	  		$rad_dashboard_options_all[ 'form_setup' ][ 'redirect_current_window_bar' ],
			$rad_dashboard_options_all[ 'form_setup' ][ 'redirect_new_tab_bar' ],
	  		$rad_dashboard_options_all[ 'form_setup' ][ 'redirect_new_window_bar' ],
	  $rad_dashboard_options_all[ 'form_setup' ][ 'rapidbar_popup' ],
		...
		$rad_dashboard_options_all['success_redirect']['section_start'],
			...
			$rad_dashboard_options_all[ 'success_redirect' ][ 'success_load_delay' ],
	  		$rad_dashboard_options_all[ 'success_redirect' ][ 'redirect_current_window' ],
