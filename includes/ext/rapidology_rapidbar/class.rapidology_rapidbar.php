...
class rapidology_rapidbar
{
	...
	public static function generate_custom_css($form_class, $single_optin = array())
	{
		...
		$custom_css .= $single_optin['display_as_link'] == 1 && $single_optin['button_text_color'] == 'light' ? '.btnaslink_light {background-color: transparent !important; text-decoration: underline !important; text-decoration-color: red !important; border: none !important; cursor: pointer !important;}' : '';
